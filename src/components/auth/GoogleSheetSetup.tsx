                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      We'll create a new Google Sheet with all the required tabs
                      and headers for your time studies.
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Connect to an existing Google Sheet. We'll add the
                      required tabs if they don't exist.
                    </p>
                  </div>
                </div>
              </button>
