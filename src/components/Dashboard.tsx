...
export default function Dashboard() {
  ...
  const { studies, loadStudies } = useStudyStore();
  ...
  useEffect(() => {
    ...
    loadProcesses();
    loadStudies();
  }, [loadCollaborators, loadProcesses, loadStudies]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Welcome to Standard Time Pro</p>
      </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-blue-600">{activeStudies.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-green-600">{collaborators.length}</p>
            </div>
          </div>
        </div>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button className="p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors text-left">
            ...
            <p className="text-sm text-gray-600">Start a new time study</p>
          </button>
          ...
          <button className="p-4 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors text-left">
            ...
            <p className="text-sm text-gray-600">Register new worker</p>
          </button>
          ...
          <button className="p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-colors text-left">
            <div className="flex items-center mb-2">
              ...
              <span className="font-medium">Add Process</span>
            </div>
            <p className="text-sm text-gray-600">Define new process</p>
          </button>
          ...
          <button className="p-4 border border-gray-200 rounded-lg hover:border-orange-300 hover:bg-orange-50 transition-colors text-left">
            ...
            <p className="text-sm text-gray-600">Check study results</p>
          </button>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-sm">Start by creating your first time study</p>
        </div>
      </div>
    </div>
  );
